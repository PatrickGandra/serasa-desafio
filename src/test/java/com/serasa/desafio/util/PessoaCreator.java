...
public final class PessoaCreator {
    ...
    public static Pessoa createPessoa() {
        return new Pessoa(1L, new Date(), "Patrick", "(32) 98877-1757", 31, "Juiz de Fora",
                          "Minas Gerais", "sudeste", 1000);
    }

    public static PessoaDTO createPessoaDTO() {
        return new PessoaDTO(1L, new Date(), "Patrick", "(32) 98877-1757", 31, "Juiz de Fora",
                             "Minas Gerais", "sudeste", 1000);
    }
    ...
    public static List<Pessoa> createListPessoa() {
        final Pessoa pessoa1 = new Pessoa(2L, new Date(), "José", "(21) 98841-9637", 45, "Rio de Janeiro",
                                      "Rio de Janeiro", "sudeste", 1000);
        final Pessoa pessoa2 = new Pessoa(3L, new Date(), "Maria", "(28) 98823-7452", 23, "Vitória",
